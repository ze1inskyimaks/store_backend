...
public class CompanyRabbitConsumer : BackgroundService
{
    ...
    public CompanyRabbitConsumer(IServiceScopeFactory scopeFactory) 
    {
        ...
        _channel.BasicConsumeAsync(queue: "company_queue", autoAck: false, consumer: new AsyncEventingBasicConsumer(_channel));
    }
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        consumer.ReceivedAsync += async (model, ea) =>
        {
            ...
            var data = JsonSerializer.Deserialize<Company>(message);
        ...
        await _channel.BasicConsumeAsync(queue: "company_queue", autoAck: false, consumer: consumer);
    }
}